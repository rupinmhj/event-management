                ...
                <div className="  mx-auto">
                    <div className="  py-6 rounded-lg ">
                        <main className="pt-5 pb-5 ">
                            <div className="mb-6">
                                <h2 className="text-2xl max-md:text-xl font-bold text-center text-gray-900 dark:text-white pb-10">
                                    Forgot Password?
                                </h2>
                                <p className="text-center text-gray-600 dark:text-gray-400 mt-2 max-md:text-[12px]">
